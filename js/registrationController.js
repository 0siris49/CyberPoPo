...
export class registrationController{
    registerUser(newUser){
        let initRegUserEntity = new userEntity();
        var result = initRegUserEntity.createToDB(newUser);
        return result;
    }
}
...
document.getElementById('regBtn').addEventListener('click', async function (event) {
    ...
    let initRegController = new registrationController();
    var result = await initRegController.registerUser(newUser);
    alert(result);
